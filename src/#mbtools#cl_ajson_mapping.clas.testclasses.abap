...
CLASS ltcl_fields DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    METHODS:
      ...
      to_abap FOR TESTING RAISING /mbtools/cx_ajson_error,
      to_abap_with_slice FOR TESTING RAISING /mbtools/cx_ajson_error,
...
CLASS ltcl_fields IMPLEMENTATION.
  ...
  METHOD to_abap_with_slice.
    ...
    DATA lt_mapping_fields TYPE /mbtools/if_ajson_mapping=>ty_mapping_fields.
    ...
    lo_cut = /mbtools/cl_ajson=>parse( iv_json           = '{"a":1,"b":{"c":2},"d":{"e":3}}'
                               ii_custom_mapping = /mbtools/cl_ajson_mapping=>create_field_mapping( lt_mapping_fields )
                               )->slice( `/b` ).
