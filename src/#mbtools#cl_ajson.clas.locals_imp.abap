    ...
    CASE lo_type->type_kind.
      ...
      WHEN lif_kind=>table.
        ...
        IF lo_table_type->table_kind <> cl_abap_tabledescr=>tablekind_std.
          /mbtools/cx_ajson_error=>raise( 'Unsupported type of input table (must be standard table)' ).
        ENDIF.
        TRY.
          ...
          CATCH cx_root.
            /mbtools/cx_ajson_error=>raise( 'Error converting input table (should be string_table)' ).
        ENDTRY.
      WHEN OTHERS.
        /mbtools/cx_ajson_error=>raise( 'Unsupported type of input (must be char, string, string_table, or xstring)' ).
    ENDCASE.
